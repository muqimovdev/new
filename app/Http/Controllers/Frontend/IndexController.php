...
class IndexController extends Controller
{
    public function mainPage()
    {
        ...
        return view('frontend.main', compact('settings', 'offers', 'products', 'reviews', 'client', 'categorys', 'partners', 'ads', 'cart', 'carts', 'orders'));
    }
    //
    ...
    public function blogPage(Request $request)
    {
        ...
        if(isset($cate)){
            $products = Product::where('category_id', 'cate')->inRandomOrder()->get();
        } else {
            $products = Product::inRandomOrder()->get();
        }
        $categorys = Category::with('cate')->get();
        $partners = Partner::get();
        $reviews = Review::get();
        $ads = Ads::get();
