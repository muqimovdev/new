                        ...
                        <div class="col-lg-8">
                            <div class="blog--post--item text-center">
                                <div class="blog-post-thumb mb-35">
                                    <a href=""><img src="{{asset('frontend/assets/img/blog/b_blog_thumb01.png')}}" width="500px" height="300px" alt=""></a>
                                </div>
                                <div class="blog-post-content">
                                    <div class="tag"><a href="#">Shopping</a></div>
                                    <h3><a href="">The Greatest Thing World Belong Excepted</a></h3>
                            ...
                            <div class="blog--post--item text-center">
                                <div class="blog-post-thumb mb-35">
                                    <a href=""><img src="i{{asset('frontend/assets/img/blog/b_blog_thumb02.png')}}" width="500px" height="300px" alt=""></a>
                                </div>
                                <div class="blog-post-content">
                                    <div class="tag"><a href="#">Shopping</a></div>
                                    <h3><a href="">Fashion is a Popular Aesthetic Expression Particular</a></h3>
                                    <div class="blog-post-meta">
                                        <ul>
                            ...
                            <div class="blog--post--item text-center">
                                <div class="blog-post-thumb mb-35">
                                    <a href=""><img src="{{asset('frontend/assets/img/blog/b_blog_thumb03.png')}}" width="500px" height="300px" alt=""></a>
                                </div>
                                <div class="blog-post-content">
                                    <div class="tag"><a href="#">Shopping</a></div>
                                    <h3><a href="">Model is a Person with a Role Either to Promote</a></h3>
                                    <div class="blog-post-meta">
                                        <ul>
                                    ...
                                    <a href="{{route('about.page')}}">Read More</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-8">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="rc-post-content">
                                                    <h5><a href="">I want you open market in andijan</a></h5>
                                                    <span><i class="far fa-calendar"></i> November 14, 2024</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="rc-post-content">
                                                    <h5><a href="">Ramadan mubarak customers</a></h5>
                                                    <span><i class="far fa-calendar"></i> April 11, 2024</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="rc-post-content">
                                                    <h5><a href="">This online market is best</a></h5>
                         ...
                         <form action="/shop" method="GET">
                            <div class="widget blog-sidebar-widget mb-45">
                                ...
                                $p_count = count($category->cate);
                                ?>
                                <div class="blog-cat-list">
                                    <ul>
                                        <li><a href="{{route('shop.page')}}" name="cate" >{{$cat_name}}</a>{{$p_count}}</li><br>
                                    </ul>
                                </div>
                                @endforeach
                            </div>
