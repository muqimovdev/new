            ...
            <div class="container custom-container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-3 col-lg-4 d-none d-lg-block">
                        <div class="logo">
                            <a href="{{ route('main.page') }}"><img src="{{asset('frontend/assets/img/logo/logo.png') }}"
                                    width="100px" alt=""></a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-5 col-md-6">
                        <div class="header-top-offer">
                      <a href="https://t.me/backend_frontend_uz"> <p>If you follow us you take <span> -10% </span> discount</p></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="header-top-action">
                            <ul>
                                ...
                                <li class="wish-list"><a href="{{route('wish.page')}}"><i class="flaticon-heart-shape-outline"></i></a>
                                </li>
                        ...
                        <div class="menu-wrap">
                            <nav class="menu-nav show">
                                ...
                                <div class="header-action d-none d-md-block">
                                    <ul>
                                        <li class="shipping-offer">We have free delivery <span> <a style="width: 20px ; color :orangered" href="{{route('blog.page')}}"> <i class="fa fa-truck"  aria-hidden="true"></i></a></span></li>
                                        <li class="header-search"><a href="#" data-toggle="modal"
                                                data-target="#search-modal"><i
                                                    class="flaticon-search-interface-symbol"></i></a></li>
                                                    <li class="sidebar-toggle-btn"><a href="#"
                                                        class="navSidebar-button"><img src="{{asset('img/logo/logo.png')}}" width="30px"
                                                            alt=""></a></li>
                                    </ul>
                                </div>
                            </nav>
                        ...
                        <div class="sidebar-info-contents">
                            <div class="content-inner">
                                ...
                                @endif
                                    ...
                                    <div class="oc-social">
                                        <ul>
                                            <li ><a href="https://t.me/backend_frontend_uz"><i class="fab fa-telegram" ></i></a></li>
                                            <li><a href="https://www.instagram.com/muqimov_dev?utm_source=qr&igsh=MWl5bzMzdjFyMzF4eg=="><i class="fab fa-instagram"></i></a></li>
                                        </ul>
                                    </div>
                                    {{-- <div class="oc-bottom">
                                        <div class="currency">
            ...
            <div class="container-fluid p-0 fix">
                                    ...
                                    <div class="slider-bg" data-background="{{ asset($offer->second_bg_image) }}">
                                        <div class="slider-content">
                                            ...
                                            <a href="/shop" class="btn animated"
                                                data-animation-in="fadeInUp" data-delay-in=".8">Shop now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="slider-bottom-nav">
                    <div class="main-slider-nav">
                        @foreach ($offers as $offer)
                            <div class="slider-nav-item mr-1">
                        ...
                        <div class="row">
                                ...
                                <div class="cat-banner-item banner-animation mb-20">
                                    <div class="thumb">
                                        <a href="/shop"><img src="{{ asset($settings->top_left_image) }}"
                                                width="390px"  height="270px" alt=""></a>
                                    </div>
                                    <div class="content">
                                        <span>NEW COLLECTION</span>
                                        <h3><a href="/shop">cheap clothes</a></h3>
                            ...
                            <div class="col-md-6">
                                <div class="cat-banner-item banner-animation mb-20">
                                    <div class="thumb">
                                        <a href="/shop"><img
                                                src="{{ asset($settings->top_right_image) }}"
                                                width="390px" height="270px"></a>
                                    </div>
                                    <div class="content">
                                        <span>NEW COLLECTION</span>
                                        <h3><a href="/shop">for jentelmens</a></h3>
                                        <a href="/shop" class="btn">shop now</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cat-banner-item style-two banner-animation mb-20">
                                    <div class="thumb">
                                        <a href="/shop"><img src="{{ asset($settings->bottom_image) }}"
                                                width="840px" height="500px" alt=""></a>
                                    </div>
                                    <div class="content">
                                        <span>NEW COLLECTION</span>
                                        <h3><a href="/shop">new clothes</a></h3>
                                        <a href="/shop" class="btn">shop now</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-md-6 col-sm-8">
                        <div class="promo-services-item mb-40">
                            <div class="icon"><img src="{{asset('frontend/assets/img/icon/hours1.png')}}" width="50px" alt=""></div>
                            <div class="content">
                                <h6>24/7 Support</h6>
                                <p>RIf you have any quetions please contact us and we answer your problem</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-8">
                        <div class="promo-services-item mb-40">
                            <div class="icon"><img src="{{asset('frontend/assets/img/icon/box1.png')}}" width="50px" alt=""></div>
                            <div class="content">
                                <h6>Store Warehouse</h6>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-8">
                        <div class="promo-services-item mb-40">
                            <div class="icon"><img src="{{asset('frontend/assets/img/icon/delivary1.png')}}" width="50px" alt=""></div>
                            <div class="content">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="features-product-item mb-30">
                                            ...
                                            <div class="features-product-content">
                                                ...
                                                <p style="color: rgb(2, 3, 2)" class="price">{{ $product->price - $product->price * ($product->discount / 100) }} $</p><br>
                                                @if($product->discount != null)
                                            <p style="color: dark " class="price"><del>{{ $product->price }} $</del></p>
                                                @endif
                            ...
                            @foreach ($categorys as $cate)
                                <div class="tab-pane {{ $loop->index == 0 ? 'show active' : '' }}"
                                    ...
                                    <div class="trending-products-banner banner-animation">
                                        <a href="/shop"><img src="{{ asset($cate->image) }}"
                                                width="470" height="362" alt=""></a>
                                    </div>
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="features-product-item mb-30">
                                                    ...
                                                    <div class="features-product-content">
                                                        ...
                                                        <p style="color: black" class="price">{{ $product->price - $product->price * ($product->discount / 100) }} $</p><br>
                                                        @if($product->discount != null)
                                                    <p style="color: dark" class="price"><del>{{ $product->price }} $</del></p>
                                                        @endif
                                                        <div class="features-product-bottom">
                                                            <ul>
                                                                ...
                                                                <li class="limited-time"><a
                                                                        href="#">LImited-time Offer!</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="features-product-cart"><a href="">add to
                                                            cart</a></div>
                                                </div>
                    ...
                    @foreach ($ads as $item)
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="https://t.me/Abrorbek007_Web_developler" target="_blank">
                    ...
                    <div class="col-12">
                        <div class="footer-logo">
                            <a href="{{ route('main.page') }}"><img
                                    src="{{asset('frontend/assets/img/logo/logo.png') }}" width="150px" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="copyright-text">
                            <p>&copy; 2024 <a href="contact">{{$settings->site_title}}</a>. Phone | +998{{$settings->phone}}</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
