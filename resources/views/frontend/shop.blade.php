    ...
    <body>
                        ...
                        <div class="col-12">
                            ...
                            <div class="menu-wrap">
                                <nav class="menu-nav show">
                                    <div class="logo">
                                        <a href="/"><img src="{{asset('frontend/assets/img/logo/logo.png') }}" width="120px" alt="Logo"></a>
                                    </div>
                                    ...
                                    <div class="header-action d-none d-md-block">
                                        ...
                                        <li class="header-wishlist"><a href="{{route('wish.page')}}"><i class="flaticon-heart-shape-outline"></i></a></li>
                                            <li class="header-shop-cart"><a href="#"><i class="flaticon-shopping-bag"></i><span>{{count($carts)}}</span></a>
                                                <ul class="minicart">
        ...
        <main>
            ...
            <section class="shop-area pt-95 pb-100">
                <div class="container">
                    <div class="shop-top-meta mb-35  text-center" >
                        <div class="row">
                   <h3>Our Products</h3>
                        </div>
                    </div>
                                ...
                                <div class="thumb mb-25">
                                    ...
                                    <div class="product-overlay-action">
                                        <ul>
                                            ...
                                            <li><a href="{{ route('main.show', $product->id) }}"><i class="far fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="footer-logo">
                                <a href="{{ route('main.page') }}"><img src="{{asset('frontend/assets/img/logo/logo.png') }}" width="150px"
                                        alt=""></a>
                            </div>
                        </div>
                    </div>
